...
+ Journeys {#journeys}
   ...
   + [&#x200B; los binnenkomende acties in reizen problemen op](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/orchestrate-journeys/troubleshoot-journey/troubleshooting-inbound){target="_blank"}
