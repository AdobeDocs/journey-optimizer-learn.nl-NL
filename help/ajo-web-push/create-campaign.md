...
description: Maak een campagne om gebruikers aan te wijzen die zich hebben aangemeld voor het ontvangen van pushberichten en het bericht op het geplande tijdstip te verzenden.
feature: Push
role: User
level: Beginner
doc-type: Tutorial
...
In deze stap maakt u een campagne in Adobe Journey Optimizer om geplande pushmeldingen via het web te verzenden naar gebruikers die zich hebben aangemeld. De campagne richt zich op een in aanmerking komend publiek en levert berichten op een vooraf bepaald tijdstip, waardoor geplande en op het publiek gebaseerde betrokkenheid mogelijk wordt.

* Aanmelden bij Journey Optimizer
* Navigeren naar Reisbeheer | Campagnes | Campagnes maken
