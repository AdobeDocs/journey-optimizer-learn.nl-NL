...
description: Leer hoe u berichtoptimalisatie kunt benutten in actie- of API-campagnes. U ziet hoe u subdoelgroepen kunt kiezen, berichtvariaties kunt maken op locatie, fallback-inhoud kunt inschakelen en meerdere experimenten kunt uitvoeren in één campagne. In deze zelfstudie wordt ook uitgelegd hoe u campagnes met meerdere kanalen kunt beheren en tegelijkertijd de consistentie van berichten kunt behouden.
feature: Campaigns
role: User
level: Beginner
