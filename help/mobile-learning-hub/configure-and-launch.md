...
| ![&#x200B; Geleide documentatie van de kanaalopstelling &#x200B;](./assets/configuration.svg) | [**Geleide documentatie van de kanaalopstelling** &#x200B;](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/configuration/guided-setup/set-mobile-config){target="_blank"} |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
